...
const SERVICES: Record<ServiceId, ServiceConfig> = {
  warehouse: {
    ...
    sections: [
      ...
      // 低温物流センターの特徴（2026-09-10 改修）：以前は「施設・設備」3枚目のカード
      // （sec.0.2）に h3＋本文をまとめて入れていたものを、他と同じ見出し構造の独立セクションにし、
      // 画像なしの h3＋本文カード2枚（PC で2列）に分けた。文言は当時の入力内容を既定値として引き継ぐ
      {
        en: "FEATURES",
        jp: "低温物流センターの特徴",
        pathKey: "features",
        ...
        items: [
          {
            title: "食品を中心に、幅広い商品をお預かり",
            body:
              "お菓子や冷凍麺、水産物など、食品を中心にお預かりしています。製品化されたものだけでなく、加工前の魚・タコ・イカといった原料をお預かりし、加工後の製品が再び戻ってくるケースもあります。長くお付き合いのあるお客様が多く、繁忙期に向けて在庫が積み上がり、連休前に一気に出荷されるといった動きにも対応しています。",
          },
          {
            title: "入出庫と在庫の管理体制",
            body:
              "専用のシステムで在庫を管理しています。100ケースをお預かりすれば入庫通知書を発行し、10ケース出荷されれば残り90ケースというように、入出庫のたびに記録と通知を行っています。月末には在庫表を発行し、お客様側の記録と照合。システムによる自動記録に加えて、人の目によるチェックも重ねることで、数量の誤差が生じないようにしています。",
          },
        ],
      },
