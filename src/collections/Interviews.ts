...
export const Interviews: CollectionConfig = {
  ...
  fields: [
    ...
    {
      // 2枚目のアイキャッチ（2026-09 追加）：採用ページ「人を知る」のカードにホバーしたとき、
      // メイン画像からこの画像へフェードで切り替わる（未設定なら切り替わらない）
      name: 'image2',
      type: 'upload',
      relationTo: 'media',
      label: 'アイキャッチ画像（2枚目・ホバー時）',
      admin: {
        description:
    ...
    },
    {
      name: 'image2Src',
      type: 'text',
      label: '2枚目画像URL（外部/移行データ用）',
      admin: { description: '通常は上の「アイキャッチ画像（2枚目）」を使用。両方ある場合はアップロード画像が優先されます。' },
    },
    {
