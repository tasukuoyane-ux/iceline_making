...
const PAGES: { label: string; path: string }[] = [
  ...
  { label: "採用: トップ", path: "/recruit" },
  { label: "採用: アイスラインとは", path: "/recruit/about" },
  { label: "採用: 仕事とカルチャー", path: "/recruit/work" },
  { label: "採用: 人を知る", path: "/recruit/people" },
  { label: "採用: 募集職種", path: "/recruit/jobs" },
  { label: "採用: エントリー", path: "/recruit/entry" },
